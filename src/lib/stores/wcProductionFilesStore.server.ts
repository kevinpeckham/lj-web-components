...
export const wcCssProductionFilesStore = derived(
	wcCssSourceFilesStore,
	($sourceFiles) => {
		interface File {
			name: string;
...
export const wcJsonProductionFilesStore = derived(
	wcJsonSourceFilesStore,
	($sourceFiles) => {
		interface File {
			name: string;
...
// js production files store
export const wcJsProductionFilesStore = derived(
	wcJsSourceFilesStore,
	($sourceFiles) => {
		interface File {
			name: string;
...
export type WcJsProductionFilesStore = typeof wcJsProductionFilesStore;
export type WcCssProductionFilesStore = typeof wcCssProductionFilesStore;
