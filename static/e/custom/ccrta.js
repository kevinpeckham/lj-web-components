!function(){
	...
	function reStyle() {
		...
		// add csp
		const csp = `<meta http-equiv="Content-Security-Policy" content="default-src 'self'; img-src 'self' https://res.cloudinary.com; style-src 'self' 'https://lj.cdn.dev'; script-src 'self' 'https://lj.cdn.dev' 'unsafe-inline'; font-src 'self' 'https://fonts.googleapis.com'; connect-src 'self'; frame-src 'self'; child-src 'self'; object-src 'none'; form-action 'self'; base-uri 'self'; block-all-mixed-content; upgrade-insecure-requests;">`;
		...
		<div id="footer-main" class="page-x-padding">
			<div id="footer-menus">
				...
				<a id="footer-brand" href="https://res.cloudinary.com/dn0pqjjbq/image/upload/v1723762116/ccrta-mark_ymcjh3.svg" title="go to home">
